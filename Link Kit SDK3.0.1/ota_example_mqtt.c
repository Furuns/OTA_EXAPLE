...
//    FILE *fp;
    char buf_ota[OTA_BUF_LEN];//1kµÄÕ» OTA_BUF_LEN == 1024
//	int res = 0;
...
//    if (NULL == (msg_buf = (char *)HAL_Malloc(OTA_MQTT_MSGLEN))) {//2kÄÚ´æ OTA_MQTT_MSGLEN == 2048
//        EXAMPLE_TRACE("not enough memory");
//        rc = -1;
//        goto do_exit;
//    }

//    if (NULL == (msg_readbuf = (char *)HAL_Malloc(OTA_MQTT_MSGLEN))) {//2kÄÚ´æ OTA_MQTT_MSGLEN == 2048
//        EXAMPLE_TRACE("not enough memory");
//        rc = -1;
//        goto do_exit;
//    }
